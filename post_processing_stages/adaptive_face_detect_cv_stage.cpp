 ...
 *
 * adaptive_face_detect_cv_stage.cpp - Face Detector implementation, using OpenCV 
 */
...
void AdaptiveFaceDetectCvStage::Configure()
{
	...
	if (draw_features_ && full_stream_->configuration().pixelFormat != libcamera::formats::YUV420)
		throw std::runtime_error("AdaptiveFaceDetectCvStage: drawing only supported for YUV420 images");
